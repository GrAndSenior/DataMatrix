...
from PyQt5.QtWidgets import (QMainWindow, QWidget, QProgressBar, QApplication, QMessageBox, QFileDialog)
...
class MarkApplication(QMainWindow, design.Ui_MainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Маркировка Datamatrix - v.0.2')
...
def main():
    ...
    if datetime.now() < datetime(2024,3,15):
